# Contributing to codewalk (santh-walk)
...
To add a new file filtering or binary detection heuristic, update the walker logic in `src/`. Ensure the performance overhead is minimal, as this is on the hot path.
